...
- **Telegram bot interface** — run workflows from Telegram (aiogram v3); starts automatically when `BOT_TOKEN` is set, reusing the same engine and services
...
- [x] Telegram bot interface (run workflows from Telegram)
